...
export class DashboardPm25WidgetComponent {
  ...
  get chartPoints(): readonly PmChartPoint[] {
  ...
  trackByPoint(_index: number, point: PmChartPoint): number {
    return point.index;
  }
