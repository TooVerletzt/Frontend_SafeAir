...
export class DashboardPm25WidgetComponent {
  ...
  readonly chartWidth = 240;
  readonly chartHeight = 112;
  private readonly minY = 0;
  private readonly maxY = 100;
  ...
  get sparklinePath(): string {
    return this.buildPath(this.history);
  }
  ...
  get areaPath(): string {
    ...
    return `${this.sparklinePath} L ${this.marginLeft + this.plotWidth} ${this.marginTop + this.plotHeight} L ${this.marginLeft} ${this.marginTop + this.plotHeight} Z`;
  }
